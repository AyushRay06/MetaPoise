...
export function LensDemo() {
  ...
  return (
    <div className=" gap-x-8 max-w-[1400px] mx-auto p-10 grid grid-cols-1 md:grid-cols-2">
      <div>
        ...
        <div className="w-full relative rounded-3xl overflow-hidden max-w-md mx-auto bg-gradient-to-r from-[#1D2235] to-[#121318] p-8 my-10">
          ...
          <div className="relative z-10">
            ...
            >
              ...
              <p className="text-neutral-200 text-left  mt-4">
                METAPOISE v1.0 has been thoughtfully curated to provide a
                platform for both learning and interaction, where ideas can
                flourish and collaborations can be born. This year’s fest
                promises an exciting array of events designed to engage and
                inspire participants from all backgrounds.
              </p>
            </motion.div>
          </div>
        </div>
